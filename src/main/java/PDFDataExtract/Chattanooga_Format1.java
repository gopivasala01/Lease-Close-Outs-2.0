...
public class Chattanooga_Format1 
{
	...
	//public static void main(String args[]) throws Exception
	{
	  ...
	  //Resident Benefits Package 
	    if(text.contains(PDFAppConfig.Chattanooga_Format1.residentBenefitsPackageAddendumCheck)&&!text.contains("Resident Benefits Package Opt-Out Addendum"))
	    {
	    ...
	    try
	    {
	    	...
	    	String[] earlyTerminationRaw = earlyTerminationSectionText.substring(earlyTerminationSectionText.indexOf(PDFAppConfig.Chattanooga_Format1.AB_earlyTerminationFee_Prior)+PDFAppConfig.Chattanooga_Format1.AB_earlyTerminationFee_Prior.length()).split(" ");
...
//					 System.out.println("Pet rent = "+PDFReader.petRent.trim());
	  ...
	  //Smart Home Agreement
	    try
	    {
	    	if(text.contains(PDFAppConfig.Chattanooga_Format1.smartHomeAgreementCheck))
	    	{
	    		PDFReader.smartHomeAgreementCheck = true;
	    		System.out.println("Smart Home Agreement is available");
	    		try
	    		{
	    			PDFReader.smartHomeAgreementFee=text.substring(text.indexOf(PDFAppConfig.Chattanooga_Format1.smartHomeAgreementFee_Prior)+PDFAppConfig.Chattanooga_Format1.smartHomeAgreementFee_Prior.length()).trim().split(" ")[0];
	    		}
	    		catch(Exception e)
	    		{

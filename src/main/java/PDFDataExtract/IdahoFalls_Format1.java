	...
	//public static void main(String args[]) throws Exception
	{
	  ...
	  //Resident Benefits Package 
	    ...
	    try
	    {
	    	...
	    	String[] earlyTerminationRaw = earlyTerminationSectionText.substring(earlyTerminationSectionText.indexOf(PDFAppConfig.IdahoFalls_Format1.AB_earlyTerminationFee_Prior)+PDFAppConfig.IdahoFalls_Format1.AB_earlyTerminationFee_Prior.length()).split(" ");

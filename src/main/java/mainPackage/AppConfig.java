...
public class AppConfig 
{
	   ...
	   //public static String lastMonthLeases1 = "Select  Company,buildingabbreviation,LeaseName from LeaseFact_dashboard where DATEDIFF(month, StartDate, GETDATE()) = 1 and Company ='Alabama'  order by id asc";
	    ...
	    public static String[] LeaseAgreementFileNames = {"REVISED_Lease_","Revised_Lease","Lease_","_Lease","Revised_TTA_Lease","TTA_Lease","Leaseback"};
		...
		//Mail credentials
		   ...
		   public static String[] IAGClientList = {"510.","AVE.","BTH.","CAP.","FOR.","HRG.","HS.","MAN.","MCH.","OFF.","PIN.","RF.","SFR3.","TH.","HH.","Lofty.Ai","TA.","SA.","68V.","ATX.","LT.LOFTY","HOH.","LT.","PRX.","ALG.","SH."};
